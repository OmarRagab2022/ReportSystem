...
class RefueseReportsScreen extends StatelessWidget {
  @override
    ...
    return BlocConsumer<SuperAdminGpCubit, SuperAdminGPState>(
      ...
      builder: (context, state) {
        return ConditionalBuilder(
          condition: SuperAdminGpCubit.get(context).refuese != null,
              ...
              child: ConditionalBuilder(
                ...
                builder: (context) => ListView.separated(
                    itemBuilder: (context, index) => reportWidget(
                        SuperAdminGpCubit.get(context).refuese[index]),
                    separatorBuilder: (context, index) => SizedBox(
                          height: 10,
                        ),
                    itemCount: SuperAdminGpCubit.get(context).refuese.length),
