  ...
  Widget build(BuildContext context) {
    return BlocConsumer<SuperAdminGpCubit, SuperAdminGPState>(
      listener: (context, state) {
        if (state is CreateUserGpSuccesState) {
          nameController.clear();
          phoneController.clear();
          emailController.clear();
          passowrdController.clear();
          facultyController.clear();
          SuperAdminGpCubit.get(context).proFileUserImage = null;
          Fluttertoast.showToast(msg: 'Add SuccessFully');
          Navigator.pop(context);
        }
        if (state is CreateUserGpErrorState) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            actions: [
              TextButton(
                  onPressed: () {
                    if (cubit.proFileUserImage != null) {
                      cubit.createUserProfiel(
                  ...
                  Center(
                    child: Stack(
                      ...
                      children: [
                        CircleAvatar(
                          radius: 69,
                          backgroundImage: cubit.proFileUserImage == null
                              ? NetworkImage(
